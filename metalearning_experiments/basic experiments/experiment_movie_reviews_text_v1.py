...
output_csv = "experiment_movie_reviews_text_v1.csv"
...
domain_name = "nltk_movie_reviews"
...
for seed in seeds:
    for iters in search_iterations:
        ...
        print(f"[MovieReviews] seed={seed}, iters={iters} => "
...
print(f"\nExperimento con Movie Reviews finalizado. Revisa: {output_csv}")
