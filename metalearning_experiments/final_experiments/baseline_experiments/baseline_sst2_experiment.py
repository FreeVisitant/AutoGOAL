...
output_csv = "experiment_sst2_baseline.csv"
...
print("Cargando dataset SST-2 (GLUE)...")

dataset = load_dataset("glue", "sst2")
X_text = dataset["train"]["sentence"]   # Las oraciones a clasificar
y = dataset["train"]["label"]             # Etiquetas: 0 (negativo) y 1 (positivo)
...
print("\nExperimento BASELINE SST-2 finalizado.")
