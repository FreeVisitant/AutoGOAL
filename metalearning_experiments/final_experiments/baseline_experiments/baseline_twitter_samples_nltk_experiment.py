...
try:
    ...
    logging.info("El corpus 'twitter_samples' ya está descargado.")
except LookupError:
    logging.info("Descargando el corpus 'twitter_samples' de NLTK...")
...
output_csv = "experiment_twitter_samples_warm_start.csv"
...
print("Cargando corpus twitter_samples...")
...
warm_start = WarmStart(
    ...
    min_alpha=-0.02,
    beta_scale=1.0,
    normalizers=[],  # Puedes agregar normalizadores si es necesario
    ...
    exclude="^(twitter_samples_warm|twitter_samples)$",  # Excluir la ejecución actual y el baseline original
...
print("\nExperimento WARM_START para twitter_samples finalizado.")
