...
output_csv = "experiment_inaugural_warm_start.csv"
...
warm_start = WarmStart(
    ...
    min_alpha=-0.02,
    beta_scale=1.0,
    normalizers=[],  # Puedes agregar normalizadores si lo consideras necesario
    ...
    exclude="^(inaugural_warm|inaugural)$",  # Excluye la ejecución actual y el baseline original
...
print("\nExperimento WARM_START inaugural finalizado.")
